...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::_internal_arg_size() const {
  return arg_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::arg_size() const {
  // @@protoc_insertion_point(field_get:mrpc.RpcHeader.arg_size)
  return _internal_arg_size();
}
inline void RpcHeader::_internal_set_arg_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  arg_size_ = value;
}
inline void RpcHeader::set_arg_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_arg_size(value);
  // @@protoc_insertion_point(field_set:mrpc.RpcHeader.arg_size)
}
